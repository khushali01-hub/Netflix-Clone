...
import { faDoor } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className="container">
            <div id="tab-1-content" className={`tab-content-item ${activeTabName === CANCEL_AT_ANY_TIME && "show"}`}>
              <div className="tab-1-content-inner">
                <div>
                  <p className="text-lg">
                    If you decide Netflix isnt't  for you - no problem.
              ...
              <div className="tab-2-content-bottom">
                <div>
                  ...
                  <p className="text-dark">
                    Smart TVs,PlayStation,Xbox,Chromecast,Apple TV,Blu-ray playes and more
                  </p>
                </div>
                <div>
          ...
          <div className="container">
            <div id="tab-3-content"
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>Monthly price after free month ends on 6/19/2022</td>
                    <td>$6.99</td>
                    <td>$11.99</td>
                    <td>$15.99</td>
                  </tr>
                  ...
                  <tr>
                    <td>Watch on your laptop, TV, phones and tablet</td>
                    <td>
                      <i className="fas fa-check"></i>
                    </td>
                    <td>
